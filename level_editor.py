...
#game window
SCREEN_WIDTH = 800
SCREEN_HEIGHT = (SCREEN_WIDTH * 0.72)
LOWER_MARGIN = 100
SIDE_MARGIN = 300
...
save_img = pygame.image.load('aset game/img/save_btn.png').convert_alpha()
load_img = pygame.image.load('aset game/img/load_btn.png').convert_alpha()
...
while run:
	...
	if save_button.draw(screen):
		#save level data
		with open(f'aset game/level{level}_data.csv', 'w', newline='') as csvfile:
